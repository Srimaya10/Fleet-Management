...
public class smoketest extends Baseclass{
	...
	public void Settings_CheckForm() throws InterruptedException
	{
	   ...
	   //Basic details
		...
		ExplicitWait_ElementToBeClickable("//input[@class=\"select2-input select2-focused\"]");
		type("//input[@class=\"select2-input select2-focused\"]", "sri maya");
		typeenter("//input[@class=\"select2-input select2-focused\"]");
		Thread.sleep(2000);
	...
	public void Settings_reminder()throws InterruptedException
	{
		...
		click("//a[@class='btn dropdown-toggle padding-none float-left mlr-5']");
		ExplicitWait_ElementToBeClickable("//input[@placeholder=\"Search folders and templates\"]");
		type("//input[@placeholder=\"Search folders and templates\"]", "Fleet reminder");
		Thread.sleep(2000);
		typeenter("//input[@placeholder=\"Search folders and templates\"]");
		Thread.sleep(2000);
		click("//span[@class=\"folder-name\"]");
	...
	public void Settings_checktemplate()throws InterruptedException
	{
		...
		selectdropdownvalue("//select[@formcontrolname=\"vehicleCheckForm\"]", "1");
	...
	public void Settings_maintenance()throws InterruptedException
	{
		...
		click("//a[@class='btn dropdown-toggle padding-none float-left mlr-5']");
		ExplicitWait_ElementToBeClickable("//input[@placeholder=\"Search folders and templates\"]");
		type("//input[@placeholder=\"Search folders and templates\"]", "Fleet maintenace");
		Thread.sleep(2000);
		typeenter("//input[@placeholder=\"Search folders and templates\"]");
		Thread.sleep(2000);
		click("//span[@class=\"folder-name\"]");
	...
	public void settings_geofence()throws InterruptedException
	{
		...
		typeenter("//input[@class=\"select2-input select2-focused\"]");
		Thread.sleep(3000);
		click("//span[contains(text(),'Finish')]");
		Thread.sleep(2000);
		click("(//input[@formcontrolname=\"confirmationText\"])[2]");
		type("(//input[@formcontrolname=\"confirmationText\"])[2]", "Activate");
		click("//button[contains(text(),' Activate')]");
		//Delete fence
		Thread.sleep(3000);
	    click("(//input[@type=\"search\"])[2]");
		Thread.sleep(1000);
	...
	public void settings_out_of_hours()throws InterruptedException
	{
        ...
        if (checkbox.isSelected()) {
    		...
    		click("//a[@class='btn dropdown-toggle padding-none float-left mlr-5']");
    		ExplicitWait_ElementToBeClickable("//input[@placeholder=\"Search folders and templates\"]");
    		type("//input[@placeholder=\"Search folders and templates\"]", "Vehicle out of hours");
    		Thread.sleep(2000);
    		typeenter("//input[@placeholder=\"Search folders and templates\"]");
    		Thread.sleep(2000);
    		click("//span[@class=\"folder-name\"]");
	...
	public void addVehicle()throws InterruptedException
	{
		...
		click("(//span[@class=\"select2-chosen\"])[2]");
		ExplicitWait_ElementToBeClickable("//input[@class=\"select2-input select2-focused\"]");
		type("//input[@class=\"select2-input select2-focused\"]", "Compact truck");
		typeenter("//input[@class=\"select2-input select2-focused\"]");
		Thread.sleep(2000);
		ExplicitWait_ElementToBeClickable("(//span[@class=\"select2-chosen\"])[3]");
		click("(//span[@class=\"select2-chosen\"])[3]");
		ExplicitWait_ElementToBeClickable("//input[@class=\"select2-input select2-focused\"]");
		type("//input[@class=\"select2-input select2-focused\"]", "Citroen");
		typeenter("//input[@class=\"select2-input select2-focused\"]");
		Thread.sleep(2000);
		...
		ExplicitWait_ElementToBeClickable("//input[@class=\"select2-input select2-focused\"]");
		type("//input[@class=\"select2-input select2-focused\"]", "Berlingo");
		typeenter("//input[@class=\"select2-input select2-focused\"]");
		click("//button[@class=\"btn btn-primary no-margin\"]");
		//Extended details
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		type("//input[contains(@class,'select2-input select')]", "Maintenance one");
		Thread.sleep(1000);
	...
	public void viewVehicle_Maintenance()throws InterruptedException
	{
		...
		selectdropdownvalue("//select[@formcontrolname=\"name\"]", "2");
	    click("//button[@class=\"btn btn-primary staus-save-btn\"]");
	    isdisplayed("//span[text()='Maintenance 2']");
